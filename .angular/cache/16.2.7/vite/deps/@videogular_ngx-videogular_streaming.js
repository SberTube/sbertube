...
// node_modules/.pnpm/@videogular+ngx-videogular@8.0.0_@angular+common@16.2.10_@angular+core@16.2.10_@angular+platf_gb3b7xycrrsivnsphc2tzdz42e/node_modules/@videogular/ngx-videogular/fesm2022/videogular-ngx-videogular-core.mjs
var _c0 = ["*"];
...
// node_modules/.pnpm/@videogular+ngx-videogular@8.0.0_@angular+common@16.2.10_@angular+core@16.2.10_@angular+platf_gb3b7xycrrsivnsphc2tzdz42e/node_modules/@videogular/ngx-videogular/fesm2022/videogular-ngx-videogular-streaming.mjs
var _VgDashDirective = class _VgDashDirective {
  constructor(ref, API) {
    this.ref = ref;
    this.API = API;
...
_VgDashDirective.ɵfac = function VgDashDirective_Factory(t) {
  return new (t || _VgDashDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(VgApiService));
};
_VgDashDirective.ɵdir = ɵɵdefineDirective({
...
var VgDashDirective = _VgDashDirective;
(function() {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(VgDashDirective, [{
    type: Directive,
    args: [{
      selector: "[vgDash]",
      exportAs: "vgDash"
...
var _VgHlsDirective = class _VgHlsDirective {
  constructor(ref, API) {
    this.ref = ref;
    this.API = API;
    this.vgHlsHeaders = {};
...
_VgHlsDirective.ɵfac = function VgHlsDirective_Factory(t) {
  return new (t || _VgHlsDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(VgApiService));
};
_VgHlsDirective.ɵdir = ɵɵdefineDirective({
...
var VgHlsDirective = _VgHlsDirective;
(function() {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(VgHlsDirective, [{
    type: Directive,
    args: [{
      selector: "[vgHls]",
      exportAs: "vgHls"
...
var _VgStreamingModule = class _VgStreamingModule {
};
_VgStreamingModule.ɵfac = function VgStreamingModule_Factory(t) {
  return new (t || _VgStreamingModule)();
};
_VgStreamingModule.ɵmod = ɵɵdefineNgModule({
  type: _VgStreamingModule,
  declarations: [VgDashDirective, VgHlsDirective],
  imports: [CommonModule, VgCoreModule],
  exports: [VgDashDirective, VgHlsDirective]
});
_VgStreamingModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule, VgCoreModule]
});
var VgStreamingModule = _VgStreamingModule;
(function() {
...
//# sourceMappingURL=@videogular_ngx-videogular_streaming.js.map
