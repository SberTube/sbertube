...
export declare class VgHLS implements OnInit, OnChanges, OnDestroy {
    ...
    destroyPlayer(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<VgHLS, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<VgHLS, "[vgHls]", ["vgHls"], { "vgHls": "vgHls"; "vgHlsHeaders": "vgHlsHeaders"; }, { "onGetBitrates": "onGetBitrates"; }, never>;
}
